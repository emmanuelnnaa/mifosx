...
public class CommandWrapperBuilder {
    ...
    public CommandWrapperBuilder deactivateCreditCheck(final String entityName, final Long loanId, 
            final Long loanCreditCheckId) {
        this.actionName = "DEACTIVATE";
        this.entityName = entityName;
        this.loanId = loanId;
        this.entityId = loanCreditCheckId;
        this.href = "/loans/" + loanId + "/creditchecks/" + loanCreditCheckId;
        return this;
    }
}